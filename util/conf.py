...
def get_parser():
    ...
    parser.add_argument(
        ...
        default="bpe-256.lex",
        help="""
            Name of the word-piece lexicon file.
            NOTE: It must be in the model dir.
        """
    )
    ...
    parser.add_argument(
        "--bpe_model",
        type=str,
        default="bpe-256.model",
        help="""
            Name of the word-piece model file.
            NOTE: It must be in the model dir.
        """
    )
    ...
    parser.add_argument(
        ...
        default="bpe-256.tok",
        help="""
            Name of the word-piece tokens file.
            NOTE: It must be in the model dir.
        """
    )
...
def get_args():
    ...
    if args.bpe == True:
        ...
        conf["sp"].load(args.load_model_dir+"/"+args.bpe_model)
        conf["src_pad_idx"] = 0
        ...
        conf["lexicon"] = args.load_model_dir+"/"+args.bpe_lexicon
        conf["tokens"] = args.load_model_dir+"/"+args.bpe_tokens
        conf["bpe_model"] = args.load_model_dir+"/"+args.bpe_model
    conf["inf"] = float('inf')
